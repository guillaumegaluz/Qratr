...
(function() {
  ...
  this.Playlist = (function(_super) {
    ...
    Playlist.prototype.initialize = function() {
      return this.tracks = new Tracks(this.get('tracks') || []);
    };
...
(function() {
  ...
  this.PlayerView = (function(_super) {

    __extends(PlayerView, _super);

    function PlayerView() {
      this.restAllTrackContainers = __bind(this.restAllTrackContainers, this);

      this.updateTrackView = __bind(this.updateTrackView, this);
      ...
      this.trackIsLoaded = __bind(this.trackIsLoaded, this);

      this.loadTrack = __bind(this.loadTrack, this);

      this.trackClicked = __bind(this.trackClicked, this);
    ...
    PlayerView.prototype.trackClicked = function(track) {
      if (this.trackIsLoaded(track)) {
        if (this.playing) {
          return this.pause();
        } else {
          return this.resume();
    ...
    PlayerView.prototype.loadTrack = function(track) {
      ...
      this.updateControls();
      return this.updateTrackView();
    };

    PlayerView.prototype.trackIsLoaded = function(track) {
      if (this.loadedTrack) {
        return track.get('soundcloud_id') === this.loadedTrack.get('soundcloud_id');
      }
    };

    PlayerView.prototype.play = function(track) {
      var _this = this;
      if (this.loadedSound) {
        this.loadedSound.stop();
      }
      this.loadTrack(track);
      SC.stream(this.loadedTrack.get('soundcloud_id'), function(sound) {
        sound.play();
        return _this.loadedSound = sound;
      });
    ...
    PlayerView.prototype.updateControls = function() {
      var trackArtist, trackTitle;
    ...
    PlayerView.prototype.updateTrackView = function() {
      var $trackContainer;
      this.restAllTrackContainers();
      $trackContainer = $(".track-container[data-track-id=" + (this.loadedTrack.get('id')) + "]");
      return $trackContainer.addClass('active');
    };

    PlayerView.prototype.restAllTrackContainers = function() {
      var _this = this;
      return $(".track-container").each(function(i, trackContainerEl) {
        return $(trackContainerEl).removeClass('active');
      });
    };
...
(function() {
  ...
  this.PlaylistView = (function(_super) {

    __extends(PlaylistView, _super);

    function PlaylistView() {
      this.initializeTracksViews = __bind(this.initializeTracksViews, this);

      this.initialize = __bind(this.initialize, this);
      return PlaylistView.__super__.constructor.apply(this, arguments);
    }

    PlaylistView.prototype.el = '.playlist-container';
    ...
    PlaylistView.prototype.initialize = function(options) {
      ...
      return this.initializeTracksViews();
    };

    PlaylistView.prototype.initializeTracksViews = function() {
      var _this = this;
      return this.$el.find('.track-container').each(function(i, trackElement) {
        var $trackElement, track;
        $trackElement = $(trackElement);
        track = _this.playlist.tracks.find(function(t) {
          return t.get('id') === $trackElement.data('track-id');
        });
...
(function() {
  ...
  this.TrackView = (function(_super) {
    ...
    TrackView.prototype.initialize = function(options) {
      return this.track = options.model;
    };

    TrackView.prototype.trackClicked = function() {
      return player.trackClicked(this.track);
    };
